...
export function Hero() {
  ...
  return (
    <div className="relative bg-background">
      ...
      <section
        id="home"
        className="snap-section relative isolate flex items-start justify-center px-4 pt-36 pb-16 sm:items-center sm:px-6 sm:pt-28 lg:px-8"
      >
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto mt-8 flex w-full max-w-2xl min-w-0 flex-col items-center text-center sm:mt-24">
