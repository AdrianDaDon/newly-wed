...
export function DressCodeSection() {
  return (
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-6xl min-w-0 grid-cols-1 items-center gap-8 sm:gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.15fr)] lg:gap-16 xl:gap-20">
        {/* Editorial copy */}
          ...
          <ul className="hidden sm:block">
            {dressCode.palette.map((swatch, index) => (
              <li
                ...
                style={{
                  zIndex: index + 1,
                  marginTop: index === 0 ? 0 : "clamp(-1.25rem, -2.5vw, -1.75rem)",
